...
phonepe_client = PhonePePaymentClient(merchant_id=settings.PHONEPE_MERCHANT_ID, salt_key=settings.PHONEPE_MERCHANT_KEY, salt_index=1, env=Env.UAT, should_publish_events=True)
